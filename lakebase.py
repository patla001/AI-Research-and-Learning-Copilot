...
Two drivers are supported, selected by COPILOT_DB_DRIVER:
...
_KEY = os.environ.get("LAKEBASE_SECRET_KEY", "copilot-lakebase-url")


def _pick_driver() -> str:
    """psycopg2 unless asked otherwise, falling back to whatever is installed."""
    choice = os.environ.get("COPILOT_DB_DRIVER", "").strip().lower()
