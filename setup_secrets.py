"""
One-time secret bootstrap for the research copilot.

Stores the Lakebase connection URL as `database/copilot-lakebase-url`, creating
...
KEY = os.environ.get("LAKEBASE_SECRET_KEY", "copilot-lakebase-url")
